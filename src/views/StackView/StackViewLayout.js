...
const IS_IPHONE_X =
  ...
  !Platform.isPad &&
  !Platform.isTVOS &&
  (WINDOW_HEIGHT === 812 || WINDOW_WIDTH === 812 || WINDOW_WIDTH === 896 || WINDOW_HEIGHT === 896);
...
class StackViewLayout extends React.Component {
  ...
  _panResponder = PanResponder.create({
    ...
    onMoveShouldSetPanResponder: (event, gesture) => {
      ...
      if (index !== scene.index) {
        // alert('false1-> index:' + index + ', scene.index:' + scene.index );
        return false;
      }
      ...
      // alert('result-> hasDraggedEnough:'+hasDraggedEnough+', axisHasBeenMeasured:' + axisHasBeenMeasured + ', isOnFirstCard:' + isOnFirstCard);
